...
IF OBJECT_ID(N'dbo.Tables', N'U') IS NOT NULL DROP TABLE dbo.Ban;
IF OBJECT_ID(N'dbo.RoleAccount', N'U') IS NOT NULL DROP TABLE dbo.RoleAccount;
IF OBJECT_ID(N'dbo.Roles', N'U') IS NOT NULL DROP TABLE dbo.Rolee;
...
(N'Biên', N'Bien123', N'Đỗ Duy Biên', N'Bien@gmail.com', N'0123456789', CAST(N'2023-01-01T00:00:00' AS SmallDateTime)),
...
(3, N'Biên', 3, 900000, 0, 8, 1, CAST(N'2025-10-10T00:00:00' AS SmallDateTime), N'Biên'),
...
(1, N'Bia', N'lon', 5, 24000, N'Cấm trẻ dưới 18', 1),
(2, N'Rượu', N'lít', 5, 100000, N'Bán khách quen', 1),
(3, N'Cháo trắng', N'tô', 3, 10000, N'Bán thêm', 1),
(4, N'Rau trộn', N'dĩa', 1, 120000, NULL, 1),
(5, N'Bò nướng tảng', N'dĩa', 2, 60000, NULL, 1),
(6, N'Nước suối', N'chai', 4, 10000, NULL, 1),
(7, N'coca', N'lon', 4, 15500, N'Ngon hon khi uong voi da.', 1),
(8, N'pepsi', N'lon', 4, 15000, N'Ngon hon khi uong voi da.', 1),
(9, N'Cà phê sữa', N'ly', 13, 25000, N'Đậm đà hương vị Việt', 1),
(10, N'Sinh tố bơ', N'ly', 16, 40000, N'Làm từ bơ tươi 100%', 1),
(11, N'Mực nướng muối ớt', N'dĩa', 17, 85000, N'Cay nhẹ', 1),
(12, N'Salad trộn dầu giấm', N'dĩa', 1, 55000, N'Tươi mát', 1),
(13, N'Cá hồi nướng', N'dĩa', 10, 180000, N'Món Âu cao cấp', 1),
(14, N'Bánh flan', N'chén', 12, 20000, N'Thêm caramel', 1),
(15, N'Bún chay', N'tô', 9, 45000, N'Món chay thanh đạm', 1),
(16, N'Kem vani', N'ly', 18, 30000, N'Lạnh ngọt mát', 1),
(17, N'Cơm gà Hải Nam', N'dĩa', 15, 65000, N'Món Á đặc trưng', 1),
(18, N'Tôm hùm nướng', N'dĩa', 10, 350000, N'Món sang trọng', 1);
