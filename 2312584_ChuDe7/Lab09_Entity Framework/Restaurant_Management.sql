...
(N'Cà phê đá', N'Ly', @DrinkId,20000, N'', 1),
(N'Trà đào', N'Ly', @DrinkId,30000, N'', 1),
(N'Cơm gà', N'Phần', @FoodId,45000, N'', 1),
(N'Bún bò', N'Tô', @FoodId,40000, N'', 1),
(N'Gỏi cuốn', N'Phần', @AppetId,25000, N'', 1),
(N'Bánh flan', N'Phần', @DessId,15000, N'', 1);
GO
